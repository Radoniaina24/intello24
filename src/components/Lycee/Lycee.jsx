...
export default function Lycee() {
  return (
    <section className="lycee py-5 bg-light">
          ...
          <div className="col-lg-8 offset-lg-2">
            ...
            <ul className="list-unstyled">
              ...
              <li className="d-flex mb-3">
                ...
                />
                <p className="m-0">
                  Professeur expérimenté Aide et soutien aux élèves en
                  difficulté scolaire (session spéciale)
                </p>
              </li>
              <li className="d-flex mb-3">
                <FontAwesomeIcon
          ...
          <div className="col-lg-8 offset-lg-2">
            ...
            <ul className="list-unstyled">
              <li className="d-flex mb-3">
                ...
                />
                <p className="m-0">Professeurs expérimentés</p>
              </li>
              <li className="d-flex mb-3">
                <FontAwesomeIcon
                  icon={faCheck}
                ...
                />
                <p className="m-0">
                  Méthodologie facile à comprendre et à assimiler pour les
                  élèves
                </p>
              </li>
              <li className="d-flex mb-3">
                ...
                />
                <p className="m-0">
                  Reconnu pour les réussites des élèves aux examens officiels
                  BEPC et Baccalauréat(toutes séries)
                </p>
              </li>
            </ul>
          </div>
            ...
            <ul className="list-unstyled">
              ...
              <li className="d-flex mb-3">
                <FontAwesomeIcon
                  ...
                  className={"text-primary fontAwesome me-2"}
                />
                <p className="m-0">Enseignement avec méthodologie rigoureuse</p>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="col-lg-8 offset-lg-2">
            ...
            <ul className="list-unstyled">
              ...
              <li className="d-flex mb-3">
                ...
                />
                <p className="m-0">
                  Inscription à l'examen officiel brevet épreuve anticipées et
                  au baccaluréat
                </p>
              </li>
              <li className="d-flex mb-3">
                ...
                />
                <p className="m-0">
                  Assistante lors de la préparation des inscriptions aux
                  différentes universités français (Par cours Sup)
                </p>
              </li>
            </ul>
          </div>
